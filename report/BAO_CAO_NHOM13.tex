...
\begin{ddgop}
\item Kiểm chứng các vai trò có thực hiện đúng chức năng được giao hay không
\item Thiết kế và chạy thí nghiệm về tác động của artifact
\item Hiệu chuẩn mức dao động nền và kiểm soát mẫu số
\item Báo cáo: tóm tắt, phương pháp đo lường, thiết lập thí nghiệm; chuẩn hoá thuật ngữ toàn bài
\end{ddgop}

\paragraph{Trương Đình Đức.}
\begin{ddgop}
\item Bảy phương pháp huấn luyện vai trò và phân tích lối tắt của từng phương pháp
\item Các hướng đã thử và loại bỏ: suy luận ngược, giải-rồi-chấm, phân rã bài toán, few-shot cho vai trò
\item Viết tài liệu phân tích cho các thí nghiệm
\item Báo cáo: mở đầu, công trình liên quan, thư mục tham khảo
\end{ddgop}

\paragraph{Trần Tùng Dương.}
\begin{ddgop}
\item Hạ tầng chạy thí nghiệm trên Kaggle và hệ thu kết quả
\item Bộ công cụ chấm điểm cho các benchmark
\item Đo khả năng khai thác, huấn luyện bộ phân loại lỗi, thí nghiệm định tuyến
\item Báo cáo: tổng hợp, kết luận và hạn chế; slide thuyết trình
\end{ddgop}

\paragraph{Lê Hoàng Quân.}
\begin{ddgop}
\item Đo đóng góp của từng vai trò bằng giá trị Shapley và chỉ số tương tác
\item Kiểm soát ngân sách sinh và mốc so sánh
\item Quy luật theo chênh lệch năng lực và kiểm chuyển miền
\item Báo cáo: phần kết quả; bộ công cụ thống kê
\end{ddgop}
...
Toàn bộ mã nguồn, kết quả tóm tắt và nhật ký thí nghiệm được công bố tại\\
\url{https://github.com/duongtrongnguyen123/multiagent-shapley-credit}\\
(nhánh \texttt{archive}; nhánh \texttt{main} chỉ chứa báo cáo và slide).
