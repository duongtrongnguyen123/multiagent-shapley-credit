...
% ---------------------------------------------------------------
\subsection{Điểm xuất phát: Đánh giá lợi ích của pipeline và mức nhiễu}\label{sec:start}
...
Sau phép kiểm soát chi phí, yếu tố chắc chắn có giá trị duy nhất là ``các lượt sinh độc lập bổ sung''. Mục tiếp theo đặt câu hỏi: những lượt sinh đó nên do vai nào và mô hình cỡ nào đảm nhiệm?
...
Một giới hạn quan trọng của phép đo này: Shapley phân bổ giá trị cho \textit{nhãn vai}, không cho \textit{chức năng} --- nếu planner lén giải bài, công của nó vẫn được ghi cho nhãn ``Planner'' dù hành vi thực tế là của solver. Mục tiếp theo phân tích các vết để trả lời liệu các vai có thực sự làm đúng chức năng của mình hay không.

% ---------------------------------------------------------------
\subsection{Vai trò: Chuyên biệt hóa chỉ là danh nghĩa và vai kiểm không thực sự kiểm soát}\label{sec:roles}
...
\subsection{Bộ chọn \(\kappa\) và định tuyến: Tín hiệu chắc chắn đạt chặn trên, tín hiệu học được không đạt}\label{sec:kappa}
