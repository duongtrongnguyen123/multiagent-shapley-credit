# H49 (dang ky truoc #55) — LAP KE HOACH CO DANG MOT LUOT KHONG, KHI BAI DU DAI?
...
PLAN  = ("Break the task into a short numbered plan of implementation steps. "
         "Describe the approach, the libraries to use, and the edge cases. "
...
p1 = pgen(MS, PLAN, PR, 0.0, 1)
p2i = {i: f"{PR[i]}\n\nPlan:\n{p1[i][0][:2000]}" for i in MINE}
