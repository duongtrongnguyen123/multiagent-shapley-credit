# H77 (dang ky truoc #86) — 'CHON hon REVIEW' co dung tren TOAN khong? (maj@k vs V_review)
...
d8 = res["maj"]["8"]["minus_Vreview"]; g8 = res["maj"]["8"]["minus_I"]
print(f"\n  maj@8 - V_review = {d8:+.4f}   <-- DAI LUONG CHINH (#86)")
print(f"  maj@8 - I        = {g8:+.4f}")
print("\n-- bang khoa #86 --")
...
if g8 < .02: print("  -> them: maj@8 khong hon I -> loi tuong quan la hien tuong CHUNG (cung co #117-b).")
