...
for fi in range(NF):
    ...
    r={"fold":fi,"n":len(qs),"greedy1":acc(a_gd),"maj8":acc(a_mj),"rerank8":acc(a_re),"oracle8":acc(a_or),
...
for k in ["greedy1","maj8","rerank8","oracle8","rerank_minus_maj","pct_gap_closed"]: out[k]=sp(k)
