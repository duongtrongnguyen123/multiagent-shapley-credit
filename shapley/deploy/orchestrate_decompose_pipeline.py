#!/usr/bin/env python3
"""Push kernel pipeline decompose (Planner -> sub-question -> Solver tuần tự) lên Kaggle T4.

  TASK=gsm8k ACCOUNT=TrgDinKai python deploy/orchestrate_decompose_pipeline.py
  TASK=math  ACCOUNT=tbmdemi   python deploy/orchestrate_decompose_pipeline.py
"""
