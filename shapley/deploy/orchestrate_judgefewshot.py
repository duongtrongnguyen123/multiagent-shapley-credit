#!/usr/bin/env python3
"""Push kernel khảo sát few-shot Judge lên Kaggle T4.

  TASK=math  ACCOUNT=TrgDinKai python deploy/orchestrate_judgefewshot.py
  TASK=gsm8k ACCOUNT=tbmdemi   python deploy/orchestrate_judgefewshot.py
"""
...
SRC = ROOT / "pipeline" / "judgefewshot_kernel.py"
BS = int(os.environ.get("BS", "8"))
TASK = os.environ.get("TASK", "math")
ACCOUNT = os.environ.get("ACCOUNT", "")
KDIR = ROOT / "kernels_judgefewshot"
