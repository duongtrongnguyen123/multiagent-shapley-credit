#!/usr/bin/env python3
"""Push kernel khảo sát Judge-vote (K=3 Judge độc lập) lên Kaggle T4.

  TASK=math  ACCOUNT=TrgDinKai python deploy/orchestrate_judgevote.py
  TASK=gsm8k ACCOUNT=tbmdemi   python deploy/orchestrate_judgevote.py
"""
...
SRC = ROOT / "pipeline" / "judgevote_kernel.py"
BS = int(os.environ.get("BS", "8"))
TASK = os.environ.get("TASK", "math")
ACCOUNT = os.environ.get("ACCOUNT", "")
KDIR = ROOT / "kernels_judgevote"
