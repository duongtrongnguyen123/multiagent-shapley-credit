...
or the OAuth identity when accounts.txt is absent.
"""
...
TEMPLATE = (ROOT / "pipeline" / "fewshot_kernel.py").read_text(encoding="utf-8")
TASK = os.environ.get("TASK", "math")
N = int(os.environ.get("N", "30"))
BS = int(os.environ.get("BS", "4"))
ACCOUNT = os.environ.get("ACCOUNT", "")
KDIR = ROOT / "kernels_fewshot"
...
def main():
    ...
    for t in tasks:
        ...
        time.sleep(2)
    (ROOT / "manifest_fewshot.json").write_text(json.dumps(manifest, indent=2))
