#!/usr/bin/env python3
"""Push kernel tự đánh giá level độ khó (selflevel) lên Kaggle T4.

Khảo sát: model 1.5B tự chấm level 1-5 cho 150 câu MATH test. Đối chiếu offline với
trace results_rescue/math (idx 0-149) để xem self_level có tương quan với S-alone-correct.

  ACCOUNT=TrgDinKai python deploy/orchestrate_selflevel.py
  N=150 ACCOUNT=tbmdemi python deploy/orchestrate_selflevel.py
"""
