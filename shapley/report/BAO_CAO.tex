...
(\S\ref{sec:rl}). Một quan sát ngoài --- tranh biện không nhất quán vượt được
self-consistency, và giảm khoảng 16 điểm ở Llama-3.1-8B trên GSM8K
\cite{mad2025baseline} --- nhất quán về hướng với mẫu hình suy giảm ở model nhỏ mà chúng tôi
quan sát độc lập.
...
\item \textbf{$\dhonest$ mới phủ một phần không gian cấu hình.} Đại lượng triển khai được đã đo
      ...
      14,6 GB: 8/9 nhánh sinh đã xong, còn một nhánh --- kết quả chưa được đọc.
