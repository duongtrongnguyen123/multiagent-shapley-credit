...
\end{enumerate}
Cách chúng tôi kiểm soát độ tin cậy của từng phép đo được mô tả ở \S\ref{sec:setup}; một nửa
số lần chạy trượt điều kiện kỹ thuật và bị loại trước khi đọc kết quả. Báo cáo dùng một số ký hiệu riêng; Bảng~\ref{tab:cheatsheet} là chỗ tra nhanh ---
