...
\item \emph{So sánh với mô hình mạnh chạy độc lập} (mốc quy chiếu thực tế trong triển khai):
      giá trị ròng tuân theo biểu thức $G - L + R$. Trong đó, tiềm năng cải thiện $G$ suy giảm
...
\begin{tikzpicture}[x=255mm, y=1.85mm]
  ...
  \node[font=\scriptsize\itshape, text=blue!80!black, anchor=north west] at (0.004, 15.2) {Vùng trần $\dceil > 0$ (có tiềm năng)};
  ...
  \node[draw=gray!45, fill=white, fill opacity=0.98, text opacity=1, rounded corners=3pt, font=\scriptsize, anchor=north, align=center, inner sep=4pt] at (0.16, -22.5) {
    \tikz[baseline=-0.5ex]{\draw[very thick, blue!80!black] (0,0) -- (0.35cm,0); \fill[blue!80!black] (0.175cm,0) circle (1.8pt);} So với \emph{mô hình yếu} (MATH) \qquad\qquad
    \tikz[baseline=-0.5ex]{\draw[very thick, red!75!black, dashed] (0,0) -- (0.35cm,0);} Trần $\dceil$ so với \emph{mô hình mạnh} (khớp MBPP) \\[2pt]
...
\emph{mô hình yếu} (đường xanh liền) tăng mạnh do cộng hưởng năng lực; trong khi trần giá trị ròng $\dceil$
so với \emph{mô hình mạnh} (đường đỏ đứt: khớp trên 15 cặp MBPP; các chấm đỏ: 3 điểm đo MATH) suy giảm
...
vượt trội hoàn toàn tiềm năng $G$ ($L \approx 11G$) khi chênh lệch năng lực lớn trên MATH;
...
đơn tuyến, mà phụ thuộc có hệ thống vào ba yếu tố định lượng: (1) tiềm năng cải thiện $G$, được
...
loại ước tính; và (3) tổn thất phơi nhiễm $L$, phát sinh từ việc tiếp xúc với ngữ cảnh sai lệch,
...
\item \textbf{Mức độ giải thích phương sai của tổn thất $L$}: Chênh lệch năng lực giải thích được
      82\% phương sai của tiềm năng $G$, nhưng chỉ giải thích được 35\% phương sai của tổn thất phơi
