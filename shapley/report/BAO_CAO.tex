...
\subsection{Tiếp xúc với artifact: đo tác động và tách cơ hội khỏi thiệt hại}\label{sec:identity}
...
% ---------------------------------------------------------------
\subsection{Giá trị nằm ở nhiều lần sinh độc lập hơn là ở cơ chế tổng hợp}\label{sec:budget}
