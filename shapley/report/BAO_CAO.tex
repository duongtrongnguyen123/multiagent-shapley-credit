...
Mục tiếp theo áp dụng phép kiểm soát thứ nhất: lợi ích này đến từ sự phối hợp giữa các vai trò hay chỉ đơn thuần là do số lượng lượt sinh tăng lên?

% ---------------------------------------------------------------
\subsection{Kiểm soát chi phí: giá trị nằm ở lượt sinh bổ sung, không phải ở vai trò tổng hợp}\label{sec:budget}
...
Sau phép kiểm soát chi phí, yếu tố chắc chắn có giá trị duy nhất là ``các lượt sinh độc lập bổ sung''. Mục tiếp theo đặt câu hỏi: những lượt sinh đó nên do vai trò nào và model cỡ nào đảm nhiệm?
