...
\item \emph{So sánh với mô hình yếu} (mốc quy chiếu thường gặp trong các nghiên cứu): vai trò 
      ...
      Do đó, hiệu ứng ghi nhận phản ánh khoảng cách năng lực nội tại kết hợp với 
...
\begin{tikzpicture}[x=255mm, y=1.85mm]
  ...
  \node[font=\scriptsize\itshape, text=blue!80!black, anchor=north west] at (0.004, 15.2) {Vùng trần $\dceil > 0$ (có dư địa)};
...
\end{tikzpicture}
\caption{Cơ chế nghịch lý mốc tham chiếu. Cùng trục hoành là khoảng cách năng lực: hiệu ứng đo so với
