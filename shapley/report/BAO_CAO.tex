...
{\normalsize\textbf{Lớp học phần:} \todoD{điền mã lớp học phần}\par}
\vspace{60pt}
...
\end{tikzpicture}
\caption{\emph{Thí nghiệm tiếp xúc} --- cho model mạnh xem bài làm của model yếu (thiết kế
chốt trước, MATH-500): hai nhánh chỉ khác nhau ở việc ngữ cảnh
...
\begin{enumerate}\itemsep2pt
  ...
  \item \textbf{Thí nghiệm cho model mạnh xem bài làm của model yếu} --- chúng tôi gọi là
        \emph{thí nghiệm tiếp xúc} --- thiết kế chốt trước, tái lập trên hai miền
        (Hình~\ref{fig:exposure}): thiệt hại của giao thức sửa đến từ việc nhìn thấy
        \emph{nội dung sai}, chứ không phải từ bản thân việc nhìn thấy; và giao thức sửa hoạt
        động như \emph{ống dẫn đáp án} hơn là bộ sửa lỗi (\S\ref{sec:termL}).
