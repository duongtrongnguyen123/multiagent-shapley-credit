...
\begin{enumerate}\itemsep2pt
  ...
  \item \textbf{Dấu của hiệu ứng do mốc so sánh quyết định}: so với model yếu, hiệu ứng tăng theo chênh lệch năng lực gần như theo định nghĩa; so với model mạnh chạy một mình --- mốc mà người triển khai thực sự đối mặt --- hiệu ứng giảm và đổi dấu. Cùng một hệ, hai mốc, hai kết luận ngược nhau; mốc phổ biến trong tài liệu là mốc bị thổi phồng (\S\ref{sec:synthesis}).
...
\section{Tổng hợp: dấu của hiệu ứng phụ thuộc mốc so sánh}\label{sec:synthesis}
