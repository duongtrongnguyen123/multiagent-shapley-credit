...
% ---------------------------------------------------------------------
% SLIDE 1: TRANG BÌA (CĂN CHỈNH RÕ RÀNG LOGO & TÊN TRƯỜNG)
% ---------------------------------------------------------------------
\begin{frame}[plain]
  \vspace{0.1cm}
  \begin{center}
...
\begin{frame}{Nội dung bài thuyết trình}
  \begin{columns}[t]
    \begin{column}{0.48\textwidth}
      \begin{block}{\textbf{Khung lý thuyết \& Cơ chế}}
        \begin{enumerate}
          ...
          \end{itemize}
          \item[\textbf{III.}] \textbf{Tương tác Artifact \& Tổn thất phơi nhiễm}
          \begin{itemize}\footnotesize
      ...
      \begin{block}{\textbf{Thực nghiệm \& Ứng dụng}}
        \begin{enumerate}
          ...
          \begin{itemize}\footnotesize
            ...
            \item Verifier tất định vs Lối tắt hàm thưởng (RL)
          \end{itemize}
          \item[\textbf{V.}] \textbf{Cơ chế mốc tham chiếu \& Thiết kế}
          \begin{itemize}\footnotesize
            \item Ngưỡng đổi dấu $g^* \approx 0{,}09$
            \item Ma trận khuyến nghị kiến trúc thực tế
          \end{itemize}
...
% =====================================================================
% PHẦN I: ĐẶT VẤN ĐỀ & KHUNG ĐỊNH NGHĨA
% =====================================================================
...
% =====================================================================
% PHẦN II: BA PHÉP KIỂM SOÁT PHƯƠNG PHÁP LUẬN
% =====================================================================
\section{Phần II: Ba phép kiểm soát phương pháp luận}

\begin{frame}{2.1. Ba sai lệch đo lường phổ biến trong y văn}
  \begin{columns}[c]
...
% =====================================================================
% PHẦN III: TƯƠNG TÁC ARTIFACT & BÓC TÁCH CƠ CHẾ
% =====================================================================
...
% =====================================================================
% PHẦN IV: ĐÓNG GÓP THEO VAI TRÒ & HUÂN LUYỆN RL
% =====================================================================
\section{Phần IV: Đóng góp vai trò \& Huấn luyện RL}

% SLIDE RIÊNG BIỆT DÀNH TRỌN CHO HÌNH SHAPLEY
\begin{frame}{4.1. Phân rã giá trị đóng góp Shapley: Kiến trúc \& 16 Liên minh}
  \centering
  \includegraphics[width=0.96\textwidth, height=0.82\textheight, keepaspectratio]{figs/pipeline_shapley_overview.png}
\end{frame}

\begin{frame}{4.1. Nhận định từ phân tích Shapley}
  \begin{columns}[t]
    \begin{column}{0.48\textwidth}
...
% SLIDE 4.3: CẮT ĐÔI HÌNH VERIFIER ĐỂ HIỂN THỊ TRỌN VẸN 2 NỬA
\begin{frame}{4.3. Huấn luyện tác tử: Hiện tượng lối tắt hàm thưởng (Reward Hacking)}
  \begin{columns}[c]
    \begin{column}{0.48\textwidth}
      \centering
...
% =====================================================================
% PHẦN V: CƠ CHẾ MỐC THAM CHIẾU & THIẾT KẾ
% =====================================================================
...
% =====================================================================
% PHẦN VI: HẠN CHẾ & TIỀM NĂNG PHÁT TRIỂN
% =====================================================================
...
% SLIDE CUỐI: CẢM ƠN ĐƠN THUẦN, TRANG TRỌNG
\begin{frame}[plain]
  ...
  {\color{AmberGold}\rule{0.3\linewidth}{1.5pt}}\\[18pt]
  
  {\Large Kính gửi lời cảm ơn chân thành và sâu sắc nhất tới}\\[8pt]
  {\LARGE\bfseries TS. TRẦN HỒNG VIỆT}\\[8pt]
  {\large cùng toàn thể quý Thầy Cô và các bạn!}\\[24pt]
  
  {\LARGE\bfseries Q \& A}\\[6pt]
